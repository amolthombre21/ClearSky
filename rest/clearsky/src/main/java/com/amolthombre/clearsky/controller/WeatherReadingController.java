...
public class WeatherReadingController {
	 ...
	 * 
	 * @param weatherReading object of {@link WeatherReading}
	 ...
	 * 
	 * @param city The name of the city for which weather property is requested
	 * @param property weather property from humidity, temperature,pressure
	 * @return specific weather property
	 * @throws Exception when property is not from humidity, temperature,pressure
	 */
	 ...
	 * 
	 * @param city The name of the city for which average weather forecast is requested
	 * @param grain grain is either hourly or daily
