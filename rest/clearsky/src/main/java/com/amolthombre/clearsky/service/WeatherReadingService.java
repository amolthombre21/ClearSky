...
public interface WeatherReadingService {
	 ...
	 * 
	 * @param weatherReading {@link WeatherReading} object 
	 ...
	 * 
	 * @param city The name of city for which weather is requested 
	 * @return {@link WeatherReading} object
	 */
	 ...
	 * 
	 * @param city The name of city for which weather property is requested 
	 * @param property The name of the weather property
	 * @return {@link WeatherReading} object
	 */
	 ...
	 * 
	 * @param city The name of city for which weather property is requested
	 * @param property property The name of the weather property
	 * @return int weather property 
	 * @throws Exception when property is not from humidity, pressure, and temperature
	 */
	public int getWeatherPropertyForCity(String city, String property) throws Exception;
	
	/**
	 * Returns {@link List} of {@link AverageWeather} object which contains daily or hourly weather average 
	 * 
	 * @param city The name of city for which average weather is requested
	 * @param grain Can be hourly or daily
